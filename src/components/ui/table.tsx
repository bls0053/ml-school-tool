...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    style={{color: "hsl(var(--chart-variant-2))"}}
    className={cn(
...
>(({ className, ...props }, ref) => (
  <th
    ...
    style={{backgroundColor: "hsl(var(--chart-variant-5))", color: "hsl(var(--chart-variant-1))"}}
    className={cn(
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn("border-r p-1 align-middle [&:has([role=checkbox])]:pr-0", className)}
    {...props}
  />
))
